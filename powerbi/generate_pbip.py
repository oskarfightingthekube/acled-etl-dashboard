...
TABLES = {
    "fact_events": {
        "cols": [("event_id_cnty","string"),("id_country","int64"),("id_date","int64"),
                 ("id_event_type","int64"),("id_actor","int64"),("id_source","int64"),
                 ("id_interaction","int64"),("iso_year","int64"),
                 ("fatalities","int64"),("civilian_targeting_flag","int64")],
        "hide": ["event_id_cnty","id_country","id_date","id_event_type","id_actor",
                 "id_source","id_interaction","iso_year"],
    },
    "dim_country": {"cols": [("id_country","int64"),("iso","int64"),
                             ("country","string"),("region","string")],
                    "hide": ["id_country","iso"]},
    "dim_date": {"cols": [("id_date","int64"),("date_key","dateTime"),("year","int64"),
                          ("quarter","int64"),("month","int64"),("month_name","string")],
                 "hide": ["id_date"], "date_table": True,
                 "sort": {"month_name": "month"}},
    "dim_event_type": {"cols": [("id_event_type","int64"),("sub_event_type","string"),
                                ("event_type","string"),("disorder_type","string")],
                       "hide": ["id_event_type"]},
    "dim_actor": {"cols": [("id_actor","int64"),("actor","string")], "hide": ["id_actor"]},
    "dim_source": {"cols": [("id_source","int64"),("source_scale","string")],
                   "hide": ["id_source"]},
    "dim_interaction": {"cols": [("id_interaction","int64"),("interaction","string")],
                        "hide": ["id_interaction"]},
...
MEASURES = [
    ...
    ("Distinct Actors", "DISTINCTCOUNT(fact_events[id_actor])", "#,0"),
    ("Distinct Countries", "DISTINCTCOUNT(fact_events[id_country])", "#,0"),
    ("Peaceful Protests",
...
PAGES = [
 ...
 ("Actors", [
    ...
    {"type":"clusteredBarChart","title":"Bloodiest interaction types",
     "category":("dim_interaction","interaction"),"y_measure":"Total Fatalities","sort":"measure"}]),
 ("Civilian Targeting", [
